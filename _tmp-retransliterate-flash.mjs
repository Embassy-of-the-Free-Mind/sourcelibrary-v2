...
// Re-transliterate pages done with flash-lite that have poor line preservation
const BOOK_IDS = [
  '6953a91277f38f6761bd545d', // Ephraem Syri Opera Omnia (ratio 0.05)
  '6953a8b277f38f6761bd365c', // Codex Sinaiticus (ratio 0.29)
  '6953a54c77f38f6761bcf531', // Philokalia (ratio 0.50)
  '6953cbb777f38f6761bdfc4d', // Codex Alexandrinus Facsimile (ratio 0.68)
];
...
async function main() {
  ...
  for (const bookId of BOOK_IDS) {
    ...
    // Get pages that were transliterated with flash-lite
    ...
    for (let i = 0; i < pages.length; i += CONCURRENCY) {
      ...
      if (i % 60 === 0 || i + CONCURRENCY >= pages.length) {
