...
- **Ran the first two production censuses:**
  ...
  - **Promote census — 346** blocked-promotion candidates (visible + translated,
    first-family disposition, held back by the hygiene gate). Result: **~202
    genuine missed firsts (~64%)**, 116 correctly left unbadged. (28 hit the
    nightly session limit and are being re-run.)
- **Wrote the standing plan:** the scaling methodology doc (#2779) and the
  whole-corpus census tracking issue (#2780).
