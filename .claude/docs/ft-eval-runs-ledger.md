...
| **2026-06-30** | **#2880 pilot ROUND 1 — live SEARCH head-to-head** | Tier-1 gemini-3-flash-preview (grounded) vs Tier-2 oracle = 52 independent Claude `sonnet` subagents (unprimed, §1 contract) | 4×13 stratified (badged×Western/non-W) | 52 | **κ=0.30 (fair); exact-verdict agreement 46%.** Dominant gap = **Tier-1 NA-blindness** (oracle 26 `not_applicable` vs Gemini 4). Badged firsts: **50% genuine / 42% NA(ill-posed) / 0% real-prior**. T1 precision(first) 90% badged·western vs 30% badged·non-western. Gemini fabrication 2/18. Cost ~$0.03 Gemini + subscription oracle. | `scripts/eval/results/ft-pilot-round-1.md` (artifact); `ft-pilot-r1-oracle.json`, `ft-pilot-r1-gemini.json`, `ft-pilot-r1-scoringkey.json`, `ft-pilot-score.mjs` | **round artifact** (measure-only, NO flips) |
