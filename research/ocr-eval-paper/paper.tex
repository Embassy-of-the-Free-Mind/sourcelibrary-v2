...
A telling stylistic mismatch reinforces this. Ravaisson-Mollien's diplomatic transcriptions~\cite{ravaisson1881} reveal that Leonardo wrote in a distinctive punctuated style with archaic spelling: ``\emph{Prosspectiua. eragione. dimostratiua, perla quale. lassperientia chonferma tutte. lechose.}'' The AI instead produces normalized modern Italian: ``\emph{Ogn' azione ne' nostri sensi \`e fatta per via d'alcuna linia.}'' The model generates text in the \emph{style of training data about Leonardo}, not in Leonardo's own orthographic style---further evidence of generation from priors rather than visual decoding.
