...
\textbf{Informed confabulation} is not random hallucination. On an optics page, five runs all discuss light, shadow, and visual rays---but with entirely different sentences. Run~1: ``\emph{Ogn' azione ne' nostri sensi \`e fatta per via d'alcuna linia.}'' Run~2: ``\emph{Li simulacri si passano l'uno per l'piracolo.}'' Both are plausible 15th-century Italian about optics. Neither can be verified against the image. The embedding--Jaccard gap (77~pp) quantifies this; run length variation ($\pm$130\%) confirms it. The model is not reading---it is performing Leonardo.
