...
export default function HeroVariants({
  ...
  return (
    <section className="relative overflow-hidden" style={{ background: '#14100c' }}>
      ...
      <div className="absolute inset-0" style={{ background: 'radial-gradient(120% 90% at 82% 18%, rgba(165,80,61,0.22) 0%, transparent 55%)' }} />
      ...
      <div className="relative max-w-[var(--container-wide)] mx-auto px-6 md:px-12 pt-24 md:pt-16 pb-14 md:pb-16 grid gap-5 md:gap-14 items-center grid-cols-[1fr_2fr] md:grid-cols-[auto_1fr]">
        {cover}
