...
export const STAGE_DETAILS: StageDetail[] = [
  ...
  },
  {
    ...
    description: 'AI vision scans every page for illustrations, emblems, diagrams, and decorative elements. Each detection includes bounding box, description, subject tags, and a museum-style label.',
