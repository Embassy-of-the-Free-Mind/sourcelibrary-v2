/**
 * Press release body — "Embassy of the Free Mind Announces Source Library" (March 2026).
 * Migrated verbatim from the original /press-release page. Header/dateline and back-link
 * are supplied by the /press-releases/[slug] route; this component renders the <article> body only.
 */
...
export default function EmbassyAnnouncesSourceLibrary() {
  return (
