  ...
  return (
    <div className="min-h-screen bg-stone-50">
      ...
      <div className="relative bg-gradient-to-br from-stone-800 via-stone-900 to-stone-800 text-white overflow-hidden">
        ...
        />
        <div className="relative max-w-[1500px] mx-auto px-6 py-16 sm:py-20">
      ...
      <div className="max-w-[1500px] mx-auto px-6 pt-10 pb-4">
      ...
      <div className="bg-stone-100 border-t border-stone-200 mt-8">
        <div className="max-w-[1500px] mx-auto px-6 py-12 text-center">
