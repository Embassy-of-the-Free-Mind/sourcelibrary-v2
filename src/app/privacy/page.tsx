    ...
    <div className="min-h-screen" style={{ background: 'var(--bg-cream)' }}>
      ...
      <main className="max-w-3xl mx-auto px-6 py-12">
        ...
        <div className="prose-content space-y-6 text-sm leading-relaxed" style={{ color: 'var(--text-secondary)' }}>
          ...
          <h2 className="text-lg font-medium mt-8 mb-3" style={{ fontFamily: 'Cormorant Garamond, Georgia, serif', color: 'var(--text-primary)' }}>What we collect</h2>
          ...
          <h2 className="text-lg font-medium mt-8 mb-3" style={{ fontFamily: 'Cormorant Garamond, Georgia, serif', color: 'var(--text-primary)' }}>What we don&rsquo;t collect</h2>
          <ul className="list-disc pl-5 space-y-2">
          ...
          <h2 className="text-lg font-medium mt-8 mb-3" style={{ fontFamily: 'Cormorant Garamond, Georgia, serif', color: 'var(--text-primary)' }}>How we use your data</h2>
          <ul className="list-disc pl-5 space-y-2">
          ...
          <h2 className="text-lg font-medium mt-8 mb-3" style={{ fontFamily: 'Cormorant Garamond, Georgia, serif', color: 'var(--text-primary)' }}>Third-party services</h2>
          <ul className="list-disc pl-5 space-y-2">
          ...
          <h2 className="text-lg font-medium mt-8 mb-3" style={{ fontFamily: 'Cormorant Garamond, Georgia, serif', color: 'var(--text-primary)' }}>Data retention</h2>
          <p>
          ...
          <h2 className="text-lg font-medium mt-8 mb-3" style={{ fontFamily: 'Cormorant Garamond, Georgia, serif', color: 'var(--text-primary)' }}>Your rights</h2>
          <p>
          ...
          <h2 className="text-lg font-medium mt-8 mb-3" style={{ fontFamily: 'Cormorant Garamond, Georgia, serif', color: 'var(--text-primary)' }}>Contact</h2>
          <p>
