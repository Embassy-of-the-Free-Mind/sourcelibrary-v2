...
export const metadata: Metadata = {
  ...
  description: 'Give Claude access to 5,000+ rare historical texts in 30 seconds. Search, read, and cite alchemical, Hermetic, and early scientific works directly in your conversation.',
  ...
  return (
    <ContentPageLayout
      header={
        <ContentHeader
          title="Connect Source Library to Claude"
          subtitle="Search, read, and cite 5,000+ rare historical texts — directly in your conversation."
        />
      }
    >
      {/* Setup steps */}
      ...
      <section className="mb-16">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
          <div className="bg-white rounded-xl border border-border-light p-5">
            <p className="text-2xl font-bold text-accent-rust">5,000+</p>
