...
export default function DevelopersPage() {
  return (
    <ContentPageLayout
      header={
        <ContentHeader
          title="For Developers & AI Systems"
          subtitle="Access 500+ translated historical texts via MCP Server or REST API. Search, quote, and cite with DOI-backed references."
        />
      }
    >
      {/* MCP Server Section */}
    ...
    "source-library": {
      ...
      "args": ["-y", "@source-library/mcp-server"]
        ...
        <div className="flex items-center gap-4 mb-8 text-sm">
          ...
          <a
            href="https://mcp.so/server/source-library"
            target="_blank"
            rel="noopener noreferrer"
        ...
        {/* MCP Tools */}
        <h3 className="text-lg font-semibold text-primary mb-4">Available Tools</h3>
        <div className="grid md:grid-cols-3 gap-4 mb-8">
          <div className="bg-white rounded-lg border border-border-light p-4">
            ...
            <p className="text-secondary text-sm mt-2">Search across all translated books by title, author, or content.</p>
          </div>
          <div className="bg-white rounded-lg border border-border-light p-4">
            <code className="text-amber-700 font-mono text-sm">get_quote</code>
            <p className="text-secondary text-sm mt-2">Get a passage with formatted academic citations and DOI.</p>
          </div>
          <div className="bg-white rounded-lg border border-border-light p-4">
            <code className="text-amber-700 font-mono text-sm">get_book</code>
            <p className="text-secondary text-sm mt-2">Get detailed book info including summary and edition data.</p>
          </div>
        </div>

        {/* Example Prompts */}
        <h3 className="text-lg font-semibold text-primary mb-4">Example Prompts</h3>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-xl border border-border-light overflow-hidden">
            <div className="bg-stone-50 px-4 py-3 border-b border-border-light">
              ...
              <p className="text-secondary text-sm mt-1">Search the library by title, author, or full text content</p>
            </div>
            <div className="p-4">
              ...
              <table className="w-full text-sm">
                <tbody>
                  ...
                  <tr className="border-b border-stone-100">
                    ...
                    <td className="py-2 text-muted">string</td>
                    <td className="py-2 text-secondary">Filter by original language (Latin, German, etc.)</td>
                  </tr>
                  <tr className="border-b border-stone-100">
                    <td className="py-2 font-mono text-amber-700">has_doi</td>
                    <td className="py-2 text-muted">boolean</td>
                    <td className="py-2 text-secondary">Only return books with DOIs</td>
                  </tr>
                  <tr>
                    <td className="py-2 font-mono text-amber-700">limit</td>
                    <td className="py-2 text-muted">number</td>
                    <td className="py-2 text-secondary">Max results (default 20)</td>
                  </tr>
                </tbody>
              </table>
          ...
          <div className="bg-white rounded-xl border border-border-light overflow-hidden">
            <div className="bg-stone-50 px-4 py-3 border-b border-border-light">
              ...
              <p className="text-secondary text-sm mt-1">Get a translated passage with formatted citations</p>
            </div>
            <div className="p-4">
              <h4 className="text-sm font-medium text-stone-700 mb-2">Parameters</h4>
              <table className="w-full text-sm">
                <tbody>
                  <tr className="border-b border-stone-100">
                    ...
                    <td className="py-2 text-muted">number</td>
                    <td className="py-2 text-secondary">Page number (required)</td>
                  </tr>
                  <tr className="border-b border-stone-100">
                    <td className="py-2 font-mono text-amber-700">include_original</td>
                    <td className="py-2 text-muted">boolean</td>
                    <td className="py-2 text-secondary">Include original language text (default true)</td>
                  </tr>
                  <tr>
                    <td className="py-2 font-mono text-amber-700">include_context</td>
                    <td className="py-2 text-muted">boolean</td>
                    <td className="py-2 text-secondary">Include adjacent pages for context</td>
                  </tr>
                </tbody>
              </table>
              <div className="mt-4 bg-stone-900 rounded-lg p-3">
          ...
          <div className="bg-white rounded-xl border border-border-light overflow-hidden">
            <div className="bg-stone-50 px-4 py-3 border-b border-border-light">
              ...
              <p className="text-secondary text-sm mt-1">Get full book metadata including summary and DOI</p>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl border border-border-light overflow-hidden">
            <div className="bg-stone-50 px-4 py-3 border-b border-border-light">
              <div className="flex items-center gap-2">
                <span className="px-2 py-0.5 bg-green-100 text-green-700 text-xs font-mono rounded">GET</span>
                <code className="text-primary">/books</code>
              </div>
              <p className="text-secondary text-sm mt-1">List all books in the library</p>
            </div>
          </div>
        </div>
      </section>
