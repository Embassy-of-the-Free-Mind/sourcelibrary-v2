...
export const metadata: Metadata = {
  ...
  description:
    'In memory of Joost R. Ritman, founder of the Bibliotheca Philosophica Hermetica — the library where Source Library began.',
  alternates: {
  ...
  return (
    <ContentPageLayout
      header={
        ...
        >
          <p className="text-accent-gold/80 font-serif italic text-sm tracking-wide">
            In memoriam
          </p>
        </ContentHeader>
      }
    ...
    >
      <div className="prose-content max-w-none">
        ...
        <p className="text-xl text-secondary leading-relaxed mb-6">
          Joost Ruben Ritman &mdash; entrepreneur, art collector, and Rosicrucian
          &mdash; gave seventy years of his life to a single mission: to gather, preserve,
          and share the hermetic, alchemical, and mystical heritage of humankind. In 1957
          he founded the{' '}
          <a
          ...
          Dutch Memory of the World Register. From it rose the Embassy of the Free Mind in
          Amsterdam&rsquo;s House with the Heads: a research institute, a publishing house,
          a museum, and an academy devoted to the freedom of the spirit.
        </p>
        ...
        <p className="text-xl text-secondary leading-relaxed mb-6">
          ...
          and between people, and never stopped believing that a single rare book, read
          and understood, could change a life.
        </p>
        ...
        <p className="text-xl text-secondary leading-relaxed mb-6">
          ...
          untranslated book became the seed of everything you can read here. The mission of
          this library &mdash; <span className="font-serif italic">ad fontes</span>, back to the
          sources &mdash; is his mission, carried forward.
        </p>
