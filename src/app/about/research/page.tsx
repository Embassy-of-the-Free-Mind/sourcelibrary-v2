...
import { BookOpen, Scale, CheckCircle2, Languages } from 'lucide-react';
  ...
  return (
    ...
    >
      <SubPageHeader
        ...
        subtitle="Benchmarking AI translations against scholarly editions"
      />
      ...
      <section className="bg-white rounded-xl border border-border-light p-6 mb-6">
        ...
        <ol className="list-decimal list-inside space-y-2 text-secondary mb-4 ml-2">
      ...
      <section className="bg-white rounded-xl border border-border-light p-6 mb-6">
        ...
        <div className="grid grid-cols-2 gap-4 mb-6 text-sm">
          <div className="bg-stone-50 rounded-lg p-3">
            <div className="text-muted mb-1">Source Text</div>
            <div className="font-medium text-primary">Corpus Hermeticum I (Poimandres)</div>
            <div className="text-secondary">Ancient Greek, 2nd-3rd century CE</div>
          </div>
          <div className="bg-stone-50 rounded-lg p-3">
            <div className="text-muted mb-1">Benchmark Edition</div>
            <div className="font-medium text-primary">Scott, Hermetica Vol. I (1924)</div>
            <div className="text-secondary">Clarendon Press, Oxford</div>
          </div>
        </div>
        ...
        <div className="bg-stone-50 border border-border-light rounded-lg p-4">
          <p className="text-sm text-stone-700">
      ...
      {/* Technical Details */}
      <section className="bg-white rounded-xl border border-border-light p-6 mb-6">
        <h2 className="text-lg font-semibold text-primary mb-4">Technical Details</h2>

        <div className="grid md:grid-cols-3 gap-4 text-sm">
          <div className="bg-stone-50 rounded-lg p-3">
            <div className="text-muted mb-1">OCR Model</div>
            <div className="font-mono text-primary">gemini-2.5-flash</div>
          </div>
          <div className="bg-stone-50 rounded-lg p-3">
            <div className="text-muted mb-1">Translation Model</div>
            <div className="font-mono text-primary">gemini-2.5-flash</div>
          </div>
          <div className="bg-stone-50 rounded-lg p-3">
            <div className="text-muted mb-1">Source Pages</div>
            <div className="font-mono text-primary">n117, n119 (Greek)</div>
          </div>
        </div>
      ...
      <section className="bg-white rounded-xl border border-border-light p-6 mb-6">
        ...
        <div className="grid grid-cols-2 gap-4 mb-6 text-sm">
          <div className="bg-stone-50 rounded-lg p-3">
            <div className="text-muted mb-1">Source Text</div>
            <div className="font-medium text-primary">Ficino, De Voluptate (On Pleasure)</div>
            <div className="text-secondary">Renaissance Latin, 1457</div>
          </div>
          <div className="bg-stone-50 rounded-lg p-3">
            <div className="text-muted mb-1">Benchmark</div>
            <div className="font-medium text-primary">Unpublished Scholarly Translation</div>
            <div className="text-secondary">Blind comparison (not in training data)</div>
          </div>
        </div>
        ...
        <div className="bg-stone-50 border border-border-light rounded-lg p-4">
          ...
          <p className="text-xs text-muted mt-2">— AI Translation, De Voluptate Ch. 1</p>
        </div>
      </section>

      {/* Methodology: Benchmark vs Pipeline */}
      <section className="bg-white rounded-xl border border-border-light p-6 mb-6">
        <h2 className="text-lg font-semibold text-primary mb-4">Benchmark vs Standard Pipeline</h2>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-border-light">
                ...
                <th className="text-left py-2 pl-4 font-medium text-muted">Standard Pipeline</th>
              </tr>
            </thead>
      ...
      {/* Future Studies */}
      <section className="bg-white rounded-xl border border-border-light p-6 mb-6">
        <h2 className="text-lg font-semibold text-primary mb-4">Future Studies</h2>
        <p className="text-secondary mb-4">
