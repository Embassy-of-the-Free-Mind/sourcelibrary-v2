...
const sources: SourceLibrary[] = [
  // === ACTIVE IMPORT PIPELINES ===
  {
    ...
    iiif: 'Custom API',
    status: 'live',
    holdings: '40M+ items (87K early English harvested)',
    highlights: 'Broadest single source. PG/PL, MGH, CSEL, Teubner, Loeb pre-1929. 106K Early English Books (EEBO microfilm rescans).',
  },
  {
    name: 'Gallica (BnF)',
    country: 'France',
  ...
  },
  {
    ...
    iiif: 'v2',
    status: 'live',
    holdings: '432K+ digitized (OAI-PMH)',
    highlights: 'Largest IIIF source. Cod.graec. (Greek MSS), VD16/17/18 early printed books, incunabula.',
  },
  {
  ...
  },
  {
    ...
    iiif: 'v2',
    status: 'live',
    holdings: '239K records (OAI-PMH)',
    highlights: 'VD16/VD17 sets. Diez (Arabic/Persian/Turkish), Hamilton (Italian humanist), Phillipps collections. All with IIIF manifests.',
  },
  {
  ...
  },
  {
    ...
    highlights: 'Aby Warburg\u2019s iconographic archive. Astrology, magic, classical tradition, Renaissance symbolism.',
    notes: '403 on all endpoints. No public image API. Contact directly for database access.',
  },
  {
  ...
  },
  {
    ...
    highlights: 'Largest Shakespeare collection. Early modern English books, alchemy, magic, witchcraft manuscripts.',
    notes: 'CloudFlare WAF blocks all automated access. Luna-based IIIF. Contact digital@folger.edu.',
  },
  {
    ...
    status: 'blocked',
    holdings: '~6M items',
    highlights: 'Book of Kells, medieval Irish MSS, early printed books.',
    notes: 'reCAPTCHA gate on digital collections. Viewer at viewer.tcd.ie may work for individual items.',
  },
  {
    ...
    status: 'blocked',
    holdings: '~24M items',
    highlights: 'Scottish Reformation, Gaelic MSS, early printed books.',
    notes: '405 on all IIIF patterns. Provides bulk METS/ALTO downloads via Data Foundry instead.',
  },
