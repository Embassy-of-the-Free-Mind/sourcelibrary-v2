...
import { FlaskConical, Zap, Link2, CheckCircle2, XCircle } from 'lucide-react';
  ...
  return (
    ...
    >
      <SubPageHeader
        ...
        subtitle="Experiment-validated settings for OCR and translation"
      />
      {/* OCR Section */}
      <section className="bg-white rounded-xl border border-border-light p-6 mb-6">
        <div className="flex items-center gap-3 mb-4">
          ...
          <h2 className="text-xl font-semibold text-primary">OCR (Optical Character Recognition)</h2>
        </div>
          ...
          <table className="w-full text-sm">
            ...
            <tbody>
              <tr className="border-b border-stone-100">
                <td className="py-2 pr-4 text-secondary">Batch 1 vs 5</td>
                <td className="py-2 px-4 text-center text-secondary">Batch 1</td>
                <td className="py-2 px-4 text-center font-mono text-secondary">17-14</td>
                <td className="py-2 pl-4 text-center">
                  <XCircle className="w-4 h-4 text-stone-400 mx-auto" />
                </td>
              </tr>
              <tr className="border-b border-stone-100">
                <td className="py-2 pr-4 text-secondary">Batch 5 vs 10</td>
                <td className="py-2 px-4 text-center text-secondary">Batch 5</td>
                <td className="py-2 px-4 text-center font-mono text-secondary">18-13</td>
                <td className="py-2 pl-4 text-center">
                  <XCircle className="w-4 h-4 text-stone-400 mx-auto" />
                </td>
              </tr>
              ...
              <tr className="border-b border-stone-100">
                <td className="py-2 pr-4 text-secondary">Simple vs Elaborate prompt</td>
                <td className="py-2 px-4 text-center text-secondary">Tie</td>
                <td className="py-2 px-4 text-center font-mono text-secondary">17-14</td>
                <td className="py-2 pl-4 text-center">
                  <XCircle className="w-4 h-4 text-stone-400 mx-auto" />
                </td>
        ...
        <div className="space-y-2 mb-6">
          {[
            ...
            <div key={item.label} className="flex items-center gap-3">
              <span className="w-6 h-6 flex items-center justify-center bg-stone-100 rounded text-xs font-medium text-secondary">
                {i + 1}
              </span>
              ...
              <span className="text-sm text-secondary w-40">{item.label}</span>
              <span className="text-sm font-mono text-muted w-12">{item.elo}</span>
            </div>
          ))}
        </div>
      ...
      <section className="bg-white rounded-xl border border-border-light p-6 mb-6">
        <div className="flex items-center gap-3 mb-4">
          ...
          <h2 className="text-xl font-semibold text-primary">Translation</h2>
        </div>
        ...
        <ul className="list-disc list-inside space-y-1 text-secondary mb-6 ml-2">
      ...
      <section className="bg-white rounded-xl border border-border-light p-6 mb-6">
        <h2 className="text-xl font-semibold text-primary mb-4">Why Different Settings?</h2>
