    ...
    >
      <div className="prose-content max-w-none">
        ...
        <p className="text-secondary mb-12 leading-relaxed">
          And this is about more than what AI was trained on. Give a capable model real access to primary sources at scale &mdash; the actual texts, every line checkable against the original scan &mdash; and it becomes a serious instrument of research and synthesis. Ask a question the whole world has asked &mdash; <em>what is mind?</em> &mdash; and it can set <a href="https://sourcelibrary.org/q/BhIfljO2ApigrcHcTeD" className="text-accent-rust hover:underline">Plato&apos;s Greek</a> beside <a href="https://sourcelibrary.org/q/BgRsFohtofMtBqdNmop" className="text-accent-rust hover:underline">Śaṅkara&apos;s Sanskrit</a>, a Tibetan master&apos;s <a href="https://sourcelibrary.org/q/BijCMw143jlgk5jBxGl" className="text-accent-rust hover:underline">pointing-out instructions</a>, and <a href="https://sourcelibrary.org/q/BilNwaKFiK2xSzX6BW5" className="text-accent-rust hover:underline">Xunzi&apos;s Chinese</a> &mdash; quoting each and linking to the page it sits on. Source Library is built for exactly that: a library both people and AI can actually read and cite, open through a public API and MCP.
        </p>
