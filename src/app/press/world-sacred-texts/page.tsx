      ...
      <div className="max-w-4xl mx-auto px-6 md:px-12 py-16">
        ...
        <div className="prose prose-stone prose-lg max-w-none leading-relaxed space-y-6">
          <p>
            ...
            <a href="https://sourcelibrary.org" className="text-amber-700 hover:text-amber-800">Source Library</a>, the AI-powered digital library created by the Embassy of the Free Mind, has expanded its collection beyond the Western esoteric tradition to encompass sacred and philosophical texts from more than 30 world traditions.
          </p>
          <p>
          ...
          <blockquote className="border-l-4 border-amber-500 pl-6 py-2 my-8 bg-amber-50/50 rounded-r-lg">
            ...
            <footer className="text-sm text-stone-500 mt-3">
              ...
              <a href="https://sourcelibrary.org/book/6953c86b77f38f6761bdc210?page=14" className="text-amber-700 hover:text-amber-800">p. 14</a>
            </footer>
          </blockquote>
          ...
          <blockquote className="border-l-4 border-amber-500 pl-6 py-2 my-8 bg-amber-50/50 rounded-r-lg">
            ...
            <footer className="text-sm text-stone-500 mt-3">
              ...
              <a href="https://sourcelibrary.org/book/6953b56577f38f6761bd979d?page=9" className="text-amber-700 hover:text-amber-800">p. 9</a>
            </footer>
          </blockquote>
          ...
          <blockquote className="border-l-4 border-amber-500 pl-6 py-2 my-8 bg-amber-50/50 rounded-r-lg">
            ...
            <footer className="text-sm text-stone-500 mt-3">
              ...
              <a href="https://sourcelibrary.org/book/695289a9ab34727b1f04dab6?page=33" className="text-amber-700 hover:text-amber-800">p. 33</a>
            </footer>
          </blockquote>
          ...
          <blockquote className="border-l-4 border-amber-500 pl-6 py-2 my-8 bg-amber-50/50 rounded-r-lg">
            ...
            <footer className="text-sm text-stone-500 mt-3">
              ...
              <a href="https://sourcelibrary.org/book/695289acab34727b1f04db44?page=81" className="text-amber-700 hover:text-amber-800">p. 81</a>
            </footer>
          </blockquote>
          ...
          <blockquote className="border-l-4 border-amber-500 pl-6 py-2 my-8 bg-amber-50/50 rounded-r-lg">
            ...
            <footer className="text-sm text-stone-500 mt-3">
              ...
              <a href="https://sourcelibrary.org/book/6992cac0d4d545ae73feea71?page=6" className="text-amber-700 hover:text-amber-800">p. 6</a>
            </footer>
          </blockquote>
          ...
          <p>
            ...
            <a href="https://sourcelibrary.org" className="text-amber-700 hover:text-amber-800">sourcelibrary.org</a> with AI translations, original text, and high-resolution page images.
          </p>
          ...
          <div className="mt-12 pt-8 border-t border-stone-200 space-y-2 text-stone-600">
            ...
            <p>
              ...
              <a href="https://sourcelibrary.org/search" className="text-amber-700 hover:text-amber-800">sourcelibrary.org/search</a>
            </p>
            <p>
