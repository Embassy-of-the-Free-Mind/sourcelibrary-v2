        ...
        <div className="prose prose-stone prose-lg max-w-none leading-relaxed space-y-6">
          ...
          <blockquote className="border-l-4 border-amber-500 pl-6 py-2 my-8 bg-amber-50/50 rounded-r-lg">
            ...
            <footer className="text-sm text-stone-500 mt-3">
              ...
              <a href="https://sourcelibrary.org/book/694f3d6cbe37f451a5324e10?page=15" className="text-amber-700 hover:text-amber-800">p. 15</a>
            </footer>
          </blockquote>
          ...
          <blockquote className="border-l-4 border-amber-500 pl-6 py-2 my-8 bg-amber-50/50 rounded-r-lg">
            ...
            <footer className="text-sm text-stone-500 mt-3">
              ...
              <a href="https://sourcelibrary.org/book/694f3d6cbe37f451a5324e10?page=30" className="text-amber-700 hover:text-amber-800">p. 30</a>
            </footer>
          </blockquote>
          ...
          <blockquote className="border-l-4 border-amber-500 pl-6 py-2 my-8 bg-amber-50/50 rounded-r-lg">
            ...
            <footer className="text-sm text-stone-500 mt-3">
              &mdash; <em>Pimander</em> (1481),{' '}
              <a href="https://sourcelibrary.org/book/694f3d6cbe37f451a5324e10?page=44" className="text-amber-700 hover:text-amber-800">p. 44</a>
            </footer>
          </blockquote>
          ...
          <blockquote className="border-l-4 border-amber-500 pl-6 py-2 my-8 bg-amber-50/50 rounded-r-lg">
            ...
            <footer className="text-sm text-stone-500 mt-3">
              &mdash; <em>Pimander</em> (1481),{' '}
              <a href="https://sourcelibrary.org/book/694f3d6cbe37f451a5324e10?page=57" className="text-amber-700 hover:text-amber-800">p. 57</a>
            </footer>
          </blockquote>
          ...
          <div className="mt-12 pt-8 border-t border-stone-200 space-y-2 text-stone-600">
            ...
            <p>
              ...
              <a href="https://sourcelibrary.org/search?q=hermes+trismegistus" className="text-amber-700 hover:text-amber-800">sourcelibrary.org/search?q=hermes+trismegistus</a>
            </p>
            <p>
