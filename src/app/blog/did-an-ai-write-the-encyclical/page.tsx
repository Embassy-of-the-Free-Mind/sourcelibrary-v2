  ...
  return (
    ...
    >
      ...
      <article className="prose-content max-w-none">
        ...
        <p className="text-secondary leading-relaxed mb-6">
          One detail did survive translation: the dash habit shows up in the Italian too (as the en-dash Italian prefers), at roughly three times the human-baseline rate. So Leo XIV &mdash; or his drafting circle &mdash; really does favor the dash. That is a fact about an author&rsquo;s style, not a confession of authorship.
        </p>
        ...
        <p className="text-secondary leading-relaxed mb-6">
          <strong>Our instrument is modest.</strong> We used a small model pair, not the large one the Binoculars paper validated; treat the paragraph rankings as relative, not absolute. And we are missing the other half of a full calibration: an <em>AI-positive</em> control &mdash; encyclical-style paragraphs deliberately generated by a model and scored the same way &mdash; which would let each passage be read as a likelihood ratio between &ldquo;looks human&rdquo; and &ldquo;looks machine.&rdquo; The cleanest human control would be Leo XIV&rsquo;s own unscripted speeches; his spoken presentation of this encyclical reportedly scored fully human. Those are the next measurements, and they would tighten the picture without, we suspect, changing its direction.
        </p>
