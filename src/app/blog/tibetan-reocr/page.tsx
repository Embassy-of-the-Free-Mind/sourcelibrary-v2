  ...
  return (
    ...
    >
      ...
      <article className="prose-content max-w-none">
        ...
        <p className="text-secondary leading-relaxed mb-6">
          What makes this collection unusual is that most of it is a copy of a known text. The Derge Kangyur, the eighteenth-century woodblock edition that scholars treat as the reference, exists as a corrected digital text, proofread by Esukhia and published in the public domain, now maintained by OpenPecha. A Bhutanese manuscript Kanjur is a different witness of the same canon, with its own variants, but a real transcription of a folio should align to the corresponding Derge passage at high identity, and an invented one should align at chance. That gives us something the rest of the library rarely has: an answer key.
        </p>
        ...
        <p className="text-sm text-muted leading-relaxed">
          The manuscripts are held by the temples and photographed by the British Library&rsquo;s <a href="https://eap.bl.uk/project/EAP310" className="text-accent-rust underline hover:text-accent-gold-dark">Endangered Archives Programme</a>. OCR models are the <a href="https://github.com/buda-base/tibetan-ocr-app" className="text-accent-rust underline hover:text-accent-gold-dark">Buddhist Digital Resource Center&rsquo;s</a>. The Derge reference text is <a href="https://github.com/OpenPecha/P000001" className="text-accent-rust underline hover:text-accent-gold-dark">Esukhia&rsquo;s</a>; the English references are <a href="https://84000.co" className="text-accent-rust underline hover:text-accent-gold-dark">84000&rsquo;s</a>, used here for evaluation only under their non-commercial licence. The manuscript images are CC BY-NC, held by the temples. Verdict files, the adjudication script, and the alignment index are described in issue #4523 of our public repository so the runs can be re-scored.
        </p>
