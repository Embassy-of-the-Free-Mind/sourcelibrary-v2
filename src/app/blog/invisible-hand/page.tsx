    ...
    >
      ...
      <article className="prose-content max-w-none">
        ...
        <p className="text-secondary leading-relaxed mb-6">
          ...
          <Link href="/book/6991e1aa339ebc850994a92a" className="text-amber-700 hover:text-amber-600 underline"><em>Nicomachean Ethics</em></Link>
        ...
        <p className="text-secondary leading-relaxed mb-6">
          In the{' '}
          <Link href="/book/6991e1a8339ebc850994a802" className="text-amber-700 hover:text-amber-600 underline"><em>Politics</em></Link>
        ...
        <p className="text-secondary leading-relaxed mb-8">
          Xenophon&apos;s{' '}
          <Link href="/book/6991e1a6339ebc850994a7af" className="text-amber-700 hover:text-amber-600 underline"><em>Oeconomicus</em></Link>
        ...
        <p className="text-secondary leading-relaxed mb-6">
          ...
          <Link href="/book/6991e1b0339ebc850994ab9e" className="text-amber-700 hover:text-amber-600 underline"><em>Summa Theologica</em></Link>
        ...
        <p className="text-secondary leading-relaxed mb-6">
          ...
          <Link href="/book/6991e16bb53cae6bb6024014" className="text-amber-700 hover:text-amber-600 underline"><em>Traictie de la Premiere Invention des Monnoies</em></Link>
        ...
        <p className="text-secondary leading-relaxed mb-6">
          <Link href="/book/6991e182339ebc8509949055" className="text-amber-700 hover:text-amber-600 underline"><strong>Francisco de Vitoria</strong></Link>
        ...
        <p className="text-secondary leading-relaxed mb-6">
          <Link href="/book/6991e186339ebc8509949409" className="text-amber-700 hover:text-amber-600 underline"><strong>Domingo de Soto</strong></Link>
        ...
        <p className="text-secondary leading-relaxed mb-6">
          <Link href="/book/6991e18b339ebc8509949bf0" className="text-amber-700 hover:text-amber-600 underline"><strong>Mart&iacute;n de Azpilcueta</strong></Link>
        ...
        <p className="text-secondary leading-relaxed mb-6">
          <Link href="/book/6991e18e339ebc8509949bf0" className="text-amber-700 hover:text-amber-600 underline"><strong>Tom&aacute;s de Mercado</strong></Link>
        ...
        <p className="text-secondary leading-relaxed mb-6">
          <Link href="/book/6991e189339ebc85099497d9" className="text-amber-700 hover:text-amber-600 underline"><strong>Luis de Molina</strong></Link>
        ...
        <p className="text-secondary leading-relaxed mb-8">
          <Link href="/book/6991e16eb53cae6bb602414e" className="text-amber-700 hover:text-amber-600 underline"><strong>Leonardus Lessius</strong></Link>
        ...
        <p className="text-secondary leading-relaxed mb-6">
          ...
          <Link href="/book/6991e191339ebc8509949f1c" className="text-amber-700 hover:text-amber-600 underline"><strong>Gasparo Scaruffi</strong></Link>
          ...
          <Link href="/book/6991e192339ebc8509949fca" className="text-amber-700 hover:text-amber-600 underline"><strong>Bernardo Davanzati</strong></Link>
        ...
        <p className="text-secondary leading-relaxed mb-6">
          ...
          <Link href="/book/6991e171b53cae6bb6024476" className="text-amber-700 hover:text-amber-600 underline"><strong>Hugo Grotius</strong></Link>
          ...
          <Link href="/book/6991e19d339ebc850994a2c3" className="text-amber-700 hover:text-amber-600 underline"><strong>Samuel von Pufendorf</strong></Link>
        ...
        <p className="text-secondary leading-relaxed mb-8">
          <Link href="/book/6991e1a2339ebc850994a53c" className="text-amber-700 hover:text-amber-600 underline"><strong>Juan de Mariana</strong></Link>
        ...
        <p className="text-secondary leading-relaxed mb-6">
          <Link href="/book/6991e175b53cae6bb602477b" className="text-amber-700 hover:text-amber-600 underline"><strong>Nicholas Barbon</strong></Link>
        ...
        <p className="text-secondary leading-relaxed mb-6">
          <Link href="/book/6991e194339ebc850994a230" className="text-amber-700 hover:text-amber-600 underline"><strong>Sir William Petty</strong></Link>
        ...
        <p className="text-secondary leading-relaxed mb-6">
          <Link href="/book/6991e173b53cae6bb60246e3" className="text-amber-700 hover:text-amber-600 underline"><strong>Sir Dudley North</strong></Link>
        ...
        <p className="text-secondary leading-relaxed mb-8">
          <Link href="/book/6991e177b53cae6bb602477b" className="text-amber-700 hover:text-amber-600 underline"><strong>John Locke</strong></Link>
        ...
        <p className="text-secondary leading-relaxed mb-6">
          <Link href="/book/69525874ab34727b1f045110" className="text-amber-700 hover:text-amber-600 underline"><strong>Ralph Cudworth</strong></Link>
        ...
        <p className="text-secondary leading-relaxed mb-6">
          <Link href="/book/6991dc80569478bd6c9d53a3" className="text-amber-700 hover:text-amber-600 underline"><strong>Joseph Butler</strong></Link>
        ...
        <p className="text-secondary leading-relaxed mb-6">
          The{' '}
          <Link href="/book/6991dc7c569478bd6c9d5078" className="text-amber-700 hover:text-amber-600 underline"><strong>Third Earl of Shaftesbury</strong></Link>
          ...
          <Link href="/book/6991dc73569478bd6c9d4af4" className="text-amber-700 hover:text-amber-600 underline"><em>System of Moral Philosophy</em></Link>
          {' '}(1755), which he taught at Glasgow to a young student named Adam Smith.
        </p>

        <p className="text-secondary leading-relaxed mb-6">
          <Link href="/book/6991dc7c569478bd6c9d5078" className="text-amber-700 hover:text-amber-600 underline"><strong>Lord Kames</strong></Link>
        ...
        <p className="text-secondary leading-relaxed mb-8">
          <Link href="/book/6991dc76569478bd6c9d4ca5" className="text-amber-700 hover:text-amber-600 underline"><strong>Adam Ferguson</strong></Link>
        ...
        <p className="text-secondary leading-relaxed mb-6">
          ...
          <Link href="/book/6991dc5c79a19ded6bdb46e5" className="text-amber-700 hover:text-amber-600 underline"><em>Lectures on Justice, Police, Revenue and Arms</em></Link>
        ...
        <p className="text-secondary leading-relaxed mb-6">
          <Link href="/book/6991dc79569478bd6c9d4e52" className="text-amber-700 hover:text-amber-600 underline"><strong>Dugald Stewart</strong></Link>
        ...
        <p className="text-secondary leading-relaxed mb-6">
          <Link href="/book/6991dc82569478bd6c9d5586" className="text-amber-700 hover:text-amber-600 underline"><strong>Thomas Reid</strong></Link>
          {' '}(<em>Essays on the Active Powers of the Human Mind</em>, 1788) and{' '}
          <Link href="/book/6991dc7f569478bd6c9d520d" className="text-amber-700 hover:text-amber-600 underline"><strong>William Paley</strong></Link>
        ...
        <p className="text-secondary leading-relaxed mb-8">
          Meanwhile,{' '}
          <Link href="/book/6991dc5879a19ded6bdb433a" className="text-amber-700 hover:text-amber-600 underline"><strong>Bernard Mandeville</strong></Link>
        ...
        <p className="text-secondary leading-relaxed mb-6">
          ...
          <Link href="/book/6991e19f339ebc850994a406" className="text-amber-700 hover:text-amber-600 underline"><strong>Pierre de Boisguilbert</strong></Link>
          ...
          <Link href="/book/6991dc69569478bd6c9d4777" className="text-amber-700 hover:text-amber-600 underline"><strong>Fran&ccedil;ois Quesnay</strong></Link>
        ...
        <p className="text-secondary leading-relaxed mb-6">
          <Link href="/book/6991dc5a79a19ded6bdb452b" className="text-amber-700 hover:text-amber-600 underline"><strong>Richard Cantillon</strong></Link>
        ...
        <p className="text-secondary leading-relaxed mb-6">
          <Link href="/book/6991dc63569478bd6c9d44ec" className="text-amber-700 hover:text-amber-600 underline"><strong>Turgot</strong></Link>
          ...
          <Link href="/book/6991dc6b569478bd6c9d488e" className="text-amber-700 hover:text-amber-600 underline"><strong>Condillac</strong></Link>
          ...
          <Link href="/book/6991dc66569478bd6c9d456d" className="text-amber-700 hover:text-amber-600 underline"><strong>Jean-Baptiste Say</strong></Link>
        ...
        <p className="text-secondary leading-relaxed mb-8">
          And then{' '}
          <Link href="/book/6991dc4879a19ded6bdb3ef9" className="text-amber-700 hover:text-amber-600 underline"><strong>Fr&eacute;d&eacute;ric Bastiat</strong></Link>
          {' '}made the metaphor explicit. His{' '}
          <Link href="/book/6991dc4879a19ded6bdb3ef9" className="text-amber-700 hover:text-amber-600 underline"><em>Harmonies &eacute;conomiques</em></Link>
