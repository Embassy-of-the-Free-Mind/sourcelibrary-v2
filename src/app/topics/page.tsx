...
export const metadata: Metadata = {
  ...
  description: 'Explore 6,000 historical texts organized into 48 topics by machine learning — from Western Alchemy to Sanskrit Jyotisha, Classical Greek to Chinese Medicine.',
