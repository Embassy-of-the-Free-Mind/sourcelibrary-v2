...
export default function HighlightsPage() {
  ...
  const highlightsByBook = highlights.reduce((acc, h) => {
    ...
    return acc;
  }, {} as Record<string, { book_title: string; book_author?: string; highlights: Highlight[] }>);
      ...
      <main className="max-w-4xl mx-auto px-4 py-8">
        {loading ? (
          ...
          <div className="space-y-8">
            {Object.entries(highlightsByBook).map(([bookId, { book_title, book_author, highlights: bookHighlights }]) => (
                ...
                <div className="px-4 py-3 bg-stone-50 border-b border-stone-200">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      {book_author && (
                        <span className="text-sm text-stone-500 ml-2">by {book_author}</span>
                      )}
                    </div>
                ...
                <div className="divide-y divide-stone-100">
                  {bookHighlights.map(highlight => (
                    <div key={highlight.id} className="p-4 group hover:bg-yellow-50/50 transition-colors">
                      <blockquote className="text-stone-700 leading-relaxed mb-3 border-l-2 border-yellow-400 pl-3 font-serif">
