...
const lateMagicEpisodes: ShwepEpisode[] = [
  { number: 146, title: "Gideon Bohak on Late-Antique Jewish Magic", url: "https://shwep.net/podcast/gideon-bohak-on-late-antique-jewish-magic/", period: "late-magic", tags: ['Knights', 'Moralia', 'Oracles', 'Peace', 'Satyricon', 'Sibylline Oracles'] },
...
const athenianAcademyEpisodes: ShwepEpisode[] = [
  ...
  { number: 188, title: "Graeme Miles on Proclus the Commentator", url: "https://shwep.net/podcast/graeme-miles-on-proclus-the-commentator/", period: "athenian-academy", tags: ['De anima', 'Kosmos', 'Proclus', 'Timaeus'] },
  ...
  { number: 193, title: "All from Nothing: Sara Rappe on Damascius", url: "https://shwep.net/podcast/all-from-nothing-sara-rappe-on-damascius/", period: "athenian-academy", tags: ['Damascius', 'De anima', 'De mysteriis', 'Hermetica', 'Hermeticum', 'Letter', 'Oracles', 'Poimandres', 'Response', 'Symbola', 'Traditio', 'kosmos'] },
