...
const romanEpisodes: ShwepEpisode[] = [
  ...
  { number: 80, title: "Michael Williams on the Trouble with 'Gnosticism'", url: "https://shwep.net/podcast/michael-williams-on-the-trouble-with-gnosticism/", period: "roman", tags: ['Nag Hammadi'] },
  ...
  { number: 82, title: "I Got Soul, And I'm Super Bad: Basilides of Alexandria", url: "https://shwep.net/podcast/i-got-soul-and-im-super-bad-basilides-of-alexandria/", period: "roman", tags: ['Basilides'] },
  { number: 83, title: "Geoffrey Smith on Valentinus and Valentinianism", url: "https://shwep.net/podcast/geoffrey-smith-on-valentinus-and-valentinianism/", period: "roman", tags: ['Valentinus', 'Nag Hammadi'] },
...
const neoplatonismEpisodes: ShwepEpisode[] = [
  ...
  { number: 115, title: "The Esoteric Plotinus, Part I: Philosophic Silence and Esoteric Reading", url: "https://shwep.net/podcast/the-esoteric-plotinus-part-i-philosophic-silence-and-esoteric-reading/", period: "neoplatonism", tags: ['Enneads', 'Plotinus', 'Republic'] },
  ...
  { number: 118, title: "Dylan Burns on Sethian Gnosticism", url: "https://shwep.net/podcast/dylan-burns-on-sethian-gnosticism/", period: "neoplatonism", tags: ['Plotinus', 'Nag Hammadi'] },
  { number: 119, title: "Jean-Marc Narbonne on Plotinus in Dialogue with the Gnostics", url: "https://shwep.net/podcast/jean-marc-narbonne-on-plotinus-in-dialogue-with-the-gnostics/", period: "neoplatonism", tags: ['Plotinus', 'Enneads', 'Nag Hammadi'] },
  ...
  { number: 128, title: "Porphyry and the Barbarians: Ethnicity, Religious Practice, and Esoteric Interpretation", url: "https://shwep.net/podcast/porphyry-and-the-barbarians-ethnicity-religious-practice-and-esoteric-interpretation/", period: "neoplatonism", tags: ['Corpus Hermeticum', 'Hermetica', 'Poimandres', 'Porphyry'] },
  { number: 129, title: "Nilufer Akcay on Porphyry's On the Cave of the Nymphs", url: "https://shwep.net/podcast/nilufer-akcay-on-porphyrys-on-the-cave-of-the-nymphs/", period: "neoplatonism", tags: ['Corpus Hermeticum', 'Hermetica', 'Poimandres', 'Porphyry', 'Republic'] },
  ...
  { number: 131, title: "Soul-Flight, Noetic Bodies, and Pneumatic Vehicles: Toward a History of the Platonist Subtle Body", url: "https://shwep.net/podcast/soul-flight-noetic-bodies-and-pneumatic-vehicles-toward-a-history-of-the-platonist-subtle-body/", period: "neoplatonism", tags: ['Asclepius', 'Corpus Hermeticum', 'Hermetica', 'Iliad'] },
...
const iamblichusEpisodes: ShwepEpisode[] = [
  ...
  { number: 135, title: "Esoteric Hermeneutics, Divine Hierarchy, and the Ineffable: The Philosophy of Iamblichus, Part I", url: "https://shwep.net/podcast/esoteric-hermeneutics-divine-hierarchy-and-the-ineffable-the-philosophy-of-iamblichus/", period: "iamblichus", tags: ['Asclepius', 'Corpus Hermeticum', 'Hermetica', 'Iamblichus', 'Poimandres'] },
  ...
  { number: 137, title: "The Esoteric Iamblichus", url: "https://shwep.net/podcast/the-esoteric-iamblichus/", period: "iamblichus", tags: ['Corpus Hermeticum', 'Hermeticum', 'Iamblichus', 'Poimandres'] },
  { number: 138, title: "The Great Theurgy Debate: Porphyry's Letter to Anebo, Iamblichus' Response, and the Question(s) of Ritual", url: "https://shwep.net/podcast/the-great-theurgy-debate-porphyrys-letter-to-anebo-iamblichus-response-and-the-questions-of-ritual/", period: "iamblichus", tags: ['Corpus Hermeticum', 'De Mysteriis', 'Hermetica', 'Iamblichus', 'Porphyry'] },
  { number: 139, title: "John Finamore on Iamblichean Theurgy in Theory and Practice", url: "https://shwep.net/podcast/john-finamore-on-iamblichean-theurgy-in-theory-and-practice/", period: "iamblichus", tags: ['De Mysteriis', 'Hermetica', 'Iamblichus'] },
  { number: 140, title: "Gregory Shaw on the Phenomenology of Iamblichean Theurgy", url: "https://shwep.net/podcast/gregory-shaw-on-the-phenomenology-of-iamblichean-theurgy/", period: "iamblichus", tags: ['Corpus Hermeticum', 'De Mysteriis', 'Hermetica', 'Iamblichus'] },
...
const lateMagicEpisodes: ShwepEpisode[] = [
  ...
  { number: 148, title: "Curses! Sarah Veale on Roman 'Curse-Tablets'", url: "https://shwep.net/podcast/curses-sarah-veale-on-roman-curse-tablets/", period: "late-magic", tags: ['Enneads', 'Greek Magical Papyri'] },
...
const christianFathersEpisodes: ShwepEpisode[] = [
  ...
  { number: 170, title: "Frederico Fidler on Sallustius' On the Gods and the World", url: "https://shwep.net/podcast/frederico-fidler-on-sallustius-on-the-gods-and-the-world/", period: "christian-fathers", tags: ['Emperor Julian', 'Julian', 'Sallustius'] },
  ...
  { number: 175, title: "Jay Bregman on Synesius of Cyrene", url: "https://shwep.net/podcast/jay-bregman-on-synesius-of-cyrene/", period: "christian-fathers", tags: ['Anthology', 'Hypatia', 'Synesius', 'Tetrabiblos'] },
  { number: 176, title: "Plato Latinus", url: "https://shwep.net/podcast/plato-latinus/", period: "christian-fathers", tags: ['Calcidius', 'Enneads', 'Orphica', 'Timaeus'] },
...
const athenianAcademyEpisodes: ShwepEpisode[] = [
  ...
  { number: 182, title: "Martiana on Martianus Capella and the Marriage of Philology and Mercury", url: "https://shwep.net/podcast/%e2%86%84-martiana-on-martianus-capella-and-the-marriage-of-philologia-and-mercury/", period: "athenian-academy", tags: ['De anima', 'De mysteriis', 'Iamblichus', 'Martianus Capella', 'Oracles'] },
  ...
  { number: 184, title: "Hierocles of Alexandria and the Pythagorean Golden Verses", url: "https://shwep.net/podcast/hierocles-of-alexandria-and-the-pythagorean-golden-verses/", period: "athenian-academy", tags: ['Enneads', 'Hierocles'] },
  ...
  { number: 193, title: "All from Nothing: Sara Rappe on Damascius", url: "https://shwep.net/podcast/all-from-nothing-sara-rappe-on-damascius/", period: "athenian-academy", tags: ['Damascius', 'De anima', 'De mysteriis', 'Hermetica', 'Hermeticum', 'Iamblichus on The Mysteries', 'Oracles', 'Poimandres', 'Traditio'] },
