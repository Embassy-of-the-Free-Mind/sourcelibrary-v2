...
const hermeticaEpisodes: ShwepEpisode[] = [
  ...
  { number: 99, title: "Total War: Polemical Esotericism in the Contra Celsum", url: "https://shwep.net/podcast/total-war-polemical-esotericism-in-the-contra-celsum/", period: "hermetica", tags: ['Origen', 'Contra Celsum'] },
  { number: 100, title: "Thrice-Greatest Hermes", url: "https://shwep.net/podcast/thrice-greatest-hermes/", period: "hermetica", tags: ['Hermes Trismegistus', 'Corpus Hermeticum'] },
...
const neoplatonismEpisodes: ShwepEpisode[] = [
  ...
  { number: 131, title: "Soul-Flight, Noetic Bodies, and Pneumatic Vehicles: Toward a History of the Platonist Subtle Body", url: "https://shwep.net/podcast/soul-flight-noetic-bodies-and-pneumatic-vehicles-toward-a-history-of-the-platonist-subtle-body/", period: "neoplatonism", tags: [] },
...
const iamblichusEpisodes: ShwepEpisode[] = [
  ...
  { number: 134, title: "Introducing Iamblichus of Chalcis", url: "https://shwep.net/podcast/introducing-iamblichus-of-chalcis/", period: "iamblichus", tags: ['Iamblichus', 'Eunapius'] },
  ...
  { number: 142, title: "Run the Numbers: The Theology of Arithmetic", url: "https://shwep.net/podcast/run-the-numbers-the-theology-of-arithmetic/", period: "iamblichus", tags: ['Iamblichus', 'Nicomachus'] },
...
const lateMagicEpisodes: ShwepEpisode[] = [
  ...
  { number: 149, title: "Exploring the Sefer ha-Razim", url: "https://shwep.net/podcast/exploring-the-sefer-ha-razim/", period: "late-magic", tags: ['Hekhalot'] },
  { number: 150, title: "The Testament of Solomon and the Solomonic Tradition, Part I", url: "https://shwep.net/podcast/the-testament-of-solomon-and-the-solomonic-tradition/", period: "late-magic", tags: ['Testament of Solomon'] },
  { number: 151, title: "The Testament of Solomon and the Solomonic Tradition, Part II", url: "https://shwep.net/podcast/the-testament-of-solomon-and-the-solomonic-tradition-part-ii/", period: "late-magic", tags: ['Testament of Solomon'] },
  ...
  { number: 155, title: "Charles Haberl on the Mandaeans", url: "https://shwep.net/podcast/charles-haberl-on-the-mandaeans/", period: "late-magic", tags: ['Mandaean'] },
  ...
  { number: 157, title: "Matteo Martelli Introduces Zosimus of Panopolis", url: "https://shwep.net/podcast/matteo-martelli-introduces-zosimus-of-panopolis/", period: "late-magic", tags: ['Zosimus', 'Book of Enoch'] },
...
const christianFathersEpisodes: ShwepEpisode[] = [
  ...
  { number: 165, title: "Joel Kalvesmaki on Evagrius of Pontus, the 'Gnostic Trilogy', and the Origenist Controversy", url: "https://shwep.net/podcast/joel-kalvesmaki-on-evagrius-of-pontus-the-gnostic-trilogy-and-the-origenist-controversy/", period: "christian-fathers", tags: ['Evagrius', 'Evagrius Ponticus', 'Origen'] },
  ...
  { number: 171, title: "'Visibly a Goddess': Heidi Marx on Sosipatra of Pergamum", url: "https://shwep.net/podcast/visibly-a-goddess-heidi-marx-on-sosipatra-of-pergamum/", period: "christian-fathers", tags: ['Iamblichus', 'Eunapius'] },
  ...
  { number: 176, title: "Plato Latinus", url: "https://shwep.net/podcast/plato-latinus/", period: "christian-fathers", tags: ['Calcidius', 'Timaeus'] },
  { number: 177, title: "Gretchen Reydams-Schils on Calcidius and the Timaeus", url: "https://shwep.net/podcast/gretchen-reydams-schils-on-calcidius-and-the-timaeus/", period: "christian-fathers", tags: ['Calcidius', 'Timaeus', 'Alcinous'] },
  ...
  { number: 180, title: "Augustine of Hippo: Saint of the Exoteric", url: "https://shwep.net/podcast/augustine-of-hippo-saint-of-the-exoteric/", period: "christian-fathers", tags: ['Augustine'] },
];
...
const athenianAcademyEpisodes: ShwepEpisode[] = [
  ...
  { number: 184, title: "Hierocles of Alexandria and the Pythagorean Golden Verses", url: "https://shwep.net/podcast/hierocles-of-alexandria-and-the-pythagorean-golden-verses/", period: "athenian-academy", tags: ['Hierocles'] },
  ...
  { number: 188, title: "Graeme Miles on Proclus the Commentator", url: "https://shwep.net/podcast/graeme-miles-on-proclus-the-commentator/", period: "athenian-academy", tags: ['Proclus', 'Timaeus'] },
  ...
  { number: 190, title: "Edward Watts on the Age of Justinian and the Closing of the Athenian Academy", url: "https://shwep.net/podcast/edward-watts-on-the-age-of-justinian-and-the-closing-of-the-athenian-academy/", period: "athenian-academy", tags: ['Proclus', 'Damascius', 'Marinus'] },
  ...
  { number: 192, title: "Hagia Sophia and the Problem of 'Esoteric Architecture'", url: "https://shwep.net/podcast/hagia-sophia-and-the-problem-of-esoteric-architecture/", period: "athenian-academy", tags: ['Procopius'] },
  ...
  { number: 194, title: "The Last Platonists? Philosophic Teaching, Christianity, and Polytheism in Late-Antique Alexandria", url: "https://shwep.net/podcast/the-last-platonists-philosophic-teaching-christianity-and-polytheism-in-late-antique-alexandria/", period: "athenian-academy", tags: ['Olympiodorus', 'Horapollo'] },
  { number: 195, title: "Contested Esotericisms at the End of Antiquity: Simplicius, Philoponus, and Olympiodorus", url: "https://shwep.net/podcast/contested-esotericisms-at-the-end-of-antiquity-simplicius-philoponus-and-olympiodorus/", period: "athenian-academy", tags: ['Simplicius', 'Olympiodorus', 'John Philoponus'] },
];
