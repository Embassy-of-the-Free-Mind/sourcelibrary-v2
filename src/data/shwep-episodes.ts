...
const introEpisodes: ShwepEpisode[] = [
  ...
  { number: 1, title: "A Secret History of Secret History, Part I", url: "https://shwep.net/podcast/a-secret-history-of-secret-history-part-i/", period: "intro", tags: ['Philostratus'] },
  { number: 2, title: "A Secret History of Secret History, Part II", url: "https://shwep.net/podcast/a-secret-history-of-secret-history-part-ii/", period: "intro", tags: ['Hermetica', 'Catalogus Codicum Astrologorum'] },
  ...
  { number: 4, title: "Richard Seaford on the Origins of the Soul", url: "https://shwep.net/podcast/richard-seaford-on-origins-soul-interview/", period: "intro", tags: ['Irenaeus'] },
  { number: 5, title: "Methodologies for the Study of Magic", url: "https://shwep.net/podcast/methodologies-for-the-study-of-magic/", period: "intro", tags: ['Das Buch Henoch'] },
...
const nearEastEpisodes: ShwepEpisode[] = [
  { number: 10, title: "Prayer to the Gods of Night: The Near-Eastern Roots of Astrology", url: "https://shwep.net/podcast/prayer-to-the-gods-of-night-the-near-eastern-roots-of-astrology/", period: "near-east", tags: ['Das Buch Henoch'] },
  { number: 11, title: "The Long Secret History of Judaism, Part I", url: "https://shwep.net/podcast/the-long-secret-history-of-judaism-part-i/", period: "near-east", tags: ['Philostratus'] },
  ...
  { number: 13, title: "From Mystery to 'Mysticism'", url: "https://shwep.net/podcast/from-mystery-to-mysticism/", period: "near-east", tags: ['Philostratus'] },
  { number: 14, title: "Methodologies for the Study of Mysticism", url: "https://shwep.net/podcast/methodologies-for-the-study-of-mysticism/", period: "near-east", tags: ['Aratus', 'Catalogus Codicum Astrologorum'] },
];

const preSocraticEpisodes: ShwepEpisode[] = [
  { number: 15, title: "For the Love of Wisdom: The Birth of Philosophy", url: "https://shwep.net/podcast/for-the-love-of-wisdom-the-birth-of-philosophy/", period: "pre-socratic", tags: ['Plutarchi De Iside'] },
  ...
  { number: 19, title: "Riddle Me This: Heraclitus of Ephesus", url: "https://shwep.net/podcast/riddle-me-this-heraclitus-of-ephesus/", period: "pre-socratic", tags: ['Oracula Chaldaica'] },
...
const platoEpisodes: ShwepEpisode[] = [
  { number: 24, title: "Introducing the Father of Western Esotericism: Plato", url: "https://shwep.net/podcast/introducing-the-father-of-western-esotericism-plato/", period: "plato", tags: ['Oracula Chaldaica'] },
  ...
  { number: 30, title: "Introducing Plato's Republic", url: "https://shwep.net/podcast/introducing-platos-republic/", period: "plato", tags: ['Irenaeus'] },
  { number: 31, title: "Sun, Line, Cave: Plato's Inner Republic", url: "https://shwep.net/podcast/sun-line-cave-platos-inner-republic/", period: "plato", tags: ['Oracula Chaldaica'] },
  ...
  { number: 33, title: "Nowhere to Go But Up: Philosophic Ascent in Plato", url: "https://shwep.net/podcast/nowhere-to-go-but-up-philosophic-ascent-in-plato/", period: "plato", tags: ['Symposium', 'Plutarchi De Iside'] },
  ...
  { number: 36, title: "Plato's Parmenides and Metaphysics", url: "https://shwep.net/podcast/platos-parmenides-and-metaphysics/", period: "plato", tags: ['Philostratus'] },
  { number: 37, title: "Peter Adamson on Plato", url: "https://shwep.net/podcast/peter-adamson-on-plato/", period: "plato", tags: ['Philostratus'] },
];
...
const hellenisticEpisodes: ShwepEpisode[] = [
  ...
  { number: 45, title: "Stoic Physics and Esoteric Metaphysics", url: "https://shwep.net/podcast/stoic-physics-and-esoteric-metaphysics/", period: "hellenistic", tags: ['Hermetica'] },
  { number: 46, title: "After Pythagoras", url: "https://shwep.net/podcast/after-pythagoras/", period: "hellenistic", tags: [] },
  { number: 47, title: "The Numbers Don't Lie: Joel Kalvesmaki on 'Pythagorean' Number", url: "https://shwep.net/podcast/the-numbers-dont-lie-joel-kalvesmaki-on-pythagorean-number/", period: "hellenistic", tags: ['Nicomachus', 'Stoicorum Veterum Fragmenta'] },
  { number: 48, title: "Pythagoras Revived: An Anatomy of Neopythagoreanism", url: "https://shwep.net/podcast/pythagoras-revived-an-anatomy-of-neopythagoreanism/", period: "hellenistic", tags: ['Nicomachus', 'Oracula Chaldaica'] },
...
const romanEpisodes: ShwepEpisode[] = [
  ...
  { number: 75, title: "The Chaldaean Oracles", url: "https://shwep.net/podcast/the-chaldaean-oracles/", period: "roman", tags: ['Chaldean Oracles', 'Oracula Chaldaica', 'Hermetica'] },
  ...
  { number: 77, title: "Korshi Dosoo on the Papyri Graecae Magicae and Western Esotericism", url: "https://shwep.net/podcast/korshi-dosoo-on-the-papyri-graeci-magici-and-western-esotericism/", period: "roman", tags: ['Greek Magical Papyri', 'Hermetica'] },
  ...
  { number: 86, title: "Matteo Martelli on the Pseudo-Democritus", url: "https://shwep.net/podcast/matteo-martelli-on-the-pseudo-democritus/", period: "roman", tags: ['Zosimus', 'Plutarchi De Iside'] },
  ...
  { number: 89, title: "The Astrology of Vettius Valens", url: "https://shwep.net/podcast/the-astrology-of-vettius-valens/", period: "roman", tags: ['Vettius Valens', 'Aratus'] },
];
...
const hermeticaEpisodes: ShwepEpisode[] = [
  ...
  { number: 98, title: "The True Account: Celsus, Origen, and Ideological Esotericism in Late Antiquity", url: "https://shwep.net/podcast/the-true-account-celsus-origen-and-ideological-esotericism-in-late-antiquity/", period: "hermetica", tags: ['Corpus Hermeticum', 'Origen', 'Hermetica'] },
  ...
  { number: 100, title: "Thrice-Greatest Hermes", url: "https://shwep.net/podcast/thrice-greatest-hermes/", period: "hermetica", tags: ['Corpus Hermeticum', 'Hermes Trismegistus', 'Pistis Sophia', 'Irenaeus'] },
  ...
  { number: 103, title: "Corpus Hermeticum I, the Poimandres", url: "https://shwep.net/podcast/corpus-hermeticum-i-the-poimandres/", period: "hermetica", tags: ['Corpus Hermeticum', 'Poimandres', 'Hermes Trismegistus', 'Irenaeus'] },
  ...
  { number: 105, title: "Other Hermetic Worlds: The Asclepius and Kore Kosmou", url: "https://shwep.net/podcast/other-hermetic-worlds-the-asclepius-and-kore-kosmou/", period: "hermetica", tags: ['Asclepius', 'Corpus Hermeticum', 'Hermes Trismegistus', 'Justin Martyr', 'Irenaeus'] },
...
const neoplatonismEpisodes: ShwepEpisode[] = [
  ...
  { number: 111, title: "'The Philosopher of our Time': Introducing Plotinus", url: "https://shwep.net/podcast/the-philosopher-of-our-time-introducing-plotinus/", period: "neoplatonism", tags: ['Plotinus', 'Justin Martyr'] },
  ...
  { number: 128, title: "Porphyry and the Barbarians: Ethnicity, Religious Practice, and Esoteric Interpretation", url: "https://shwep.net/podcast/porphyry-and-the-barbarians-ethnicity-religious-practice-and-esoteric-interpretation/", period: "neoplatonism", tags: ['Corpus Hermeticum', 'Poimandres', 'Porphyry', 'Hermetica'] },
  { number: 129, title: "Nilufer Akcay on Porphyry's On the Cave of the Nymphs", url: "https://shwep.net/podcast/nilufer-akcay-on-porphyrys-on-the-cave-of-the-nymphs/", period: "neoplatonism", tags: ['Corpus Hermeticum', 'Poimandres', 'Porphyry', 'Hermetica'] },
  { number: 130, title: "Methodologies for Studying the Subtle Body", url: "https://shwep.net/podcast/methodologies-for-studying-the-subtle-body/", period: "neoplatonism", tags: ['Asclepius', 'Corpus Hermeticum', 'Poimandres', 'Hermetica'] },
  { number: 131, title: "Soul-Flight, Noetic Bodies, and Pneumatic Vehicles: Toward a History of the Platonist Subtle Body", url: "https://shwep.net/podcast/soul-flight-noetic-bodies-and-pneumatic-vehicles-toward-a-history-of-the-platonist-subtle-body/", period: "neoplatonism", tags: ['Asclepius', 'Corpus Hermeticum', 'Iliad', 'Hermetica'] },
  { number: 132, title: "Astral Accretions, Fate, and the Resurrection-Body: Other Subtle Bodies of Antiquity", url: "https://shwep.net/podcast/astral-accretions-fate-and-the-resurrection-body-other-subtle-bodies-of-antiquity/", period: "neoplatonism", tags: ['Corpus Hermeticum', 'Poimandres', 'Hermetica'] },
];

const iamblichusEpisodes: ShwepEpisode[] = [
  { number: 133, title: "A Word to Conjure With: On 'Theurgy' in Late Antiquity and Beyond", url: "https://shwep.net/podcast/a-word-to-conjure-with-on-theurgy-in-late-antiquity-and-beyond/", period: "iamblichus", tags: ['Chaldean Oracles', 'Collection des anciens alchimistes grecs', 'Corpus Hermeticum', 'Iamblichus', 'Poimandres', 'Hermetica'] },
  ...
  { number: 135, title: "Esoteric Hermeneutics, Divine Hierarchy, and the Ineffable: The Philosophy of Iamblichus, Part I", url: "https://shwep.net/podcast/esoteric-hermeneutics-divine-hierarchy-and-the-ineffable-the-philosophy-of-iamblichus/", period: "iamblichus", tags: ['Asclepius', 'Corpus Hermeticum', 'Iamblichus', 'Poimandres', 'Hermetica'] },
  { number: 136, title: "The 'Greater Kinds', Souls, and Kosmos: Iamblichus' Philosophy, Part II", url: "https://shwep.net/podcast/the-greater-kinds-souls-and-kosmos-introducing-iamblichus-philosophy-part-ii/", period: "iamblichus", tags: ['Asclepius', 'Corpus Hermeticum', 'Iamblichus', 'Poimandres', 'Hermetica'] },
  ...
  { number: 139, title: "John Finamore on Iamblichean Theurgy in Theory and Practice", url: "https://shwep.net/podcast/john-finamore-on-iamblichean-theurgy-in-theory-and-practice/", period: "iamblichus", tags: ['De Mysteriis', 'Corpus Hermeticum', 'Iamblichus', 'Oracula Chaldaica', 'Hermetica'] },
  { number: 140, title: "Gregory Shaw on the Phenomenology of Iamblichean Theurgy", url: "https://shwep.net/podcast/gregory-shaw-on-the-phenomenology-of-iamblichean-theurgy/", period: "iamblichus", tags: ['Corpus Hermeticum', 'De Mysteriis', 'Iamblichus', 'Oracula Chaldaica', 'Hermetica'] },
  ...
  { number: 142, title: "Run the Numbers: The Theology of Arithmetic", url: "https://shwep.net/podcast/run-the-numbers-the-theology-of-arithmetic/", period: "iamblichus", tags: ['Corpus Hermeticum', 'Iamblichus', 'Nicomachus', 'Hermetica'] },
  { number: 143, title: "Politics and Religion in Late Antiquity, Part I: Geopolitics, Empire, and Rabbinic Judaism", url: "https://shwep.net/podcast/politics-and-religion-in-late-antiquity-part-i-geopolitics-empire-and-rabbinic-judaism/", period: "iamblichus", tags: ['De mysteriis', 'Corpus Hermeticum', 'Poimandres', 'Oracula Chaldaica', 'Hermetica'] },
...
const lateMagicEpisodes: ShwepEpisode[] = [
  ...
  { number: 217, title: "The Esoteric New Testament, Part I: The Gospel of Mark", url: "https://shwep.net/podcast/the-esoteric-new-testament-part-i-the-gospel-of-mark/", period: "late-magic", tags: ['Jewish Antiquities', 'Novum Testamentum', 'Irenaeus'] },
  ...
  { number: 220, title: "The Esoteric New Testament, Part III: John and Apocalypse", url: "https://shwep.net/podcast/the-esoteric-new-testament-part-iii-john-and-apocalypse/", period: "late-magic", tags: ['Apocalypse of John', 'Gospel of John', 'Novum Testamentum', 'Irenaeus'] },
  ...
  { number: 225, title: "Into the Light-Worlds with Charles H\u00e4berl", url: "https://shwep.net/podcast/into-the-light-worlds-with-charles-haberl/", period: "late-magic", tags: ['Niebuhr'] },
  ...
  { number: 238, title: "Storytime: Reading Zosimus of Panopolis On the Letter Omega", url: "https://shwep.net/podcast/storytime-reading-zosimus-of-panopolis-on-the-letter-omega/", period: "late-magic", tags: ['Sibylline Oracles', 'Irenaeus'] },
...
const christianFathersEpisodes: ShwepEpisode[] = [
  ...
  { number: 172, title: "'And When Rome Falls, Falls the World': The Fall of Rome and Western Esotericism", url: "https://shwep.net/podcast/and-when-rome-falls-falls-the-world-the-fall-of-rome-and-western-esotericism/", period: "christian-fathers", tags: ['Porphyry', 'Oracula Chaldaica'] },
  ...
  { number: 248, title: "Storytime: Reading Eunapius Part II, The Emperor and the Thaumaturge", url: "https://shwep.net/podcast/storytime-reading-eunapius-part-ii-the-emperor-and-the-thaumaturge/", period: "christian-fathers", tags: ['Ammianus Marcellinus', 'Philostratus'] },
  ...
  { number: 255, title: "Storytime: Reading Synesius On Dreams", url: "https://shwep.net/podcast/storytime-reading-synesius-on-dreams/", period: "christian-fathers", tags: ['Golden Verses', 'Oracula Chaldaica'] },
  ...
  { number: 266, title: "Poseidonius of Rhodes, Weird Stoicism, and 'Cosmic Religion'", url: "https://shwep.net/podcast/poseidonius-of-rhodes-weird-stoicism-and-cosmic-religion/", period: "christian-fathers", tags: ['De trinitate', 'Stoicorum Veterum Fragmenta'] },
  { number: 270, title: "Storytime: Reading Macrobius' Commentary on the Dream of Scipio, Part I", url: "https://shwep.net/podcast/storytime-reading-macrobius-commentary-on-the-dream-of-scipio-part-i/", period: "christian-fathers", tags: ['Commentary on the Dream of Scipio', 'Macrobius'] },
...
const athenianAcademyEpisodes: ShwepEpisode[] = [
  { number: 181, title: "Macrobius and the Commentary on Scipio's Dream", url: "https://shwep.net/podcast/macrobius-and-the-commentary-on-scipios-dream/", period: "athenian-academy", tags: ['De insomniis', 'Dream of Scipio', 'Macrobius', 'Phaedo', 'Phaedrus', 'Timaeus', 'Oracula Chaldaica'] },
  { number: 182, title: "Martiana on Martianus Capella and the Marriage of Philology and Mercury", url: "https://shwep.net/podcast/%e2%86%84-martiana-on-martianus-capella-and-the-marriage-of-philologia-and-mercury/", period: "athenian-academy", tags: ['De anima', 'De mysteriis', 'Iamblichus', 'Martianus Capella', 'Oracula Chaldaica'] },
  ...
  { number: 185, title: "Dylan Burns on Proclus the Successor", url: "https://shwep.net/podcast/dylan-burns-on-proclus-the-successor/", period: "athenian-academy", tags: ['Corpus Hermeticum', 'Elements of Theology', 'Pistis Sophia', 'Poimandres', 'Proclus', 'Macrobius', 'Hermetica'] },
  { number: 186, title: "The Esoteric Proclus, Part I: The Life and Thought of an Esoteric Sage", url: "https://shwep.net/podcast/the-esoteric-proclus-part-i-the-life-and-thought-of-an-esoteric-sage/", period: "athenian-academy", tags: ['Chronographia', 'De anima', 'De mysteriis', 'Elements of Theology', 'Proclus', 'Oracula Chaldaica', 'Philostratus'] },
  ...
  { number: 192, title: "Hagia Sophia and the Problem of 'Esoteric Architecture'", url: "https://shwep.net/podcast/hagia-sophia-and-the-problem-of-esoteric-architecture/", period: "athenian-academy", tags: ['De anima', 'Procopius', 'Philostratus'] },
  { number: 193, title: "All from Nothing: Sara Rappe on Damascius", url: "https://shwep.net/podcast/all-from-nothing-sara-rappe-on-damascius/", period: "athenian-academy", tags: ['Damascius', 'De anima', 'De mysteriis', 'Corpus Hermeticum', 'Corpus Hermeticum', 'Iamblichus on The Mysteries', 'Poimandres', 'Oracula Chaldaica', 'Hermetica'] },
  { number: 194, title: "The Last Platonists? Philosophic Teaching, Christianity, and Polytheism in Late-Antique Alexandria", url: "https://shwep.net/podcast/the-last-platonists-philosophic-teaching-christianity-and-polytheism-in-late-antique-alexandria/", period: "athenian-academy", tags: ['De anima', 'De mysteriis', 'Horapollo', 'Olympiodorus', 'Oracula Chaldaica'] },
  ...
  // Oddcasts, storytimes, and supplementary episodes (215+)
  { number: 267, title: "Storytime: Reading Cicero's Dream of Scipio", url: "https://shwep.net/podcast/storytime-reading-ciceros-dream-of-scipio/", period: "athenian-academy", tags: ['Dream of Scipio', 'Macrobius'] },
  ...
  { number: 296, title: "Storytime: Reading Damascius' Philosophic History, Part I: Text, Context, and Themes", url: "https://shwep.net/podcast/storytime-reading-damascius-philosophic-history-part-i-text-context-and-themes/", period: "athenian-academy", tags: ['Damascius', 'Suidas', 'Eunapius'] },
  { number: 297, title: "Michæl Griffin on the Higher Virtues in Late Platonism", url: "https://shwep.net/podcast/michael-griffin-on-the-higher-virtues-in-late-platonism/", period: "athenian-academy", tags: ['Damascius'] },
  { number: 298, title: "Storytime: Reading Damascius' Philosophic History, Part II: Theurgy and Philosophy at Late-Antique Athens and Alexandria", url: "https://shwep.net/podcast/storytime-reading-damascius-philosophic-history-part-ii-theurgy-and-philosophy-at-late-antique-athens-and-alexandria/", period: "athenian-academy", tags: ['Damascius', 'Zacharias Scholasticus'] },
  { number: 299, title: "Storytime: Reading Damascius' Philosophic History, Part III: The Breaking of the Golden Chain", url: "https://shwep.net/podcast/storytime-reading-damascius-philosophic-history-part-iii-the-breaking-of-the-golden-chain/", period: "athenian-academy", tags: ['Damascius'] },
  { number: 300, title: "An Apollonian Man: Plato at the End of Antiquity in the Anonymous Prolegomena", url: "https://shwep.net/podcast/an-apollonian-man-plato-at-the-end-of-antiquity-in-the-anonymous-prolegomena/", period: "athenian-academy", tags: ['Diogenes Laertius'] },
];
...
const postAntiquityEpisodes: ShwepEpisode[] = [
  ...
  { number: 199, title: "Paul Pasquesi on the Book of the Holy Hierotheos", url: "https://shwep.net/podcast/paul-pasquesi-on-the-book-of-the-holy-hierotheos/", period: "post-antiquity", tags: ['De Mysteriis', 'De insomniis', 'De mysteriis', 'Corpus Hermeticum', 'Pseudo-Dionysius', 'Hermetica', 'Plutarchi De Iside'] },
  { number: 200, title: "Introducing Islam", url: "https://shwep.net/podcast/introducing-islam/", period: "post-antiquity", tags: ['De mysteriis', 'Oracula Chaldaica'] },
  { number: 201, title: "Matthew Melvin-Koushki on Islam, 'the West', and Western Esotericism", url: "https://shwep.net/podcast/matthew-melvin-koushki-on-islam-the-west-and-western-esotericism/", period: "post-antiquity", tags: ['Iamblichus', 'Nicomachus'] },
  ...
  { number: 207, title: "Ahab Bdaiwi on 'Ali ibn Abi Talib, his Family, and the Origins of Shi'i Islam", url: "https://shwep.net/podcast/ahab-bdaiwi-on-ali-ibn-abi-%e1%b9%adalib-his-family-and-the-origins-of-shii-islam/", period: "post-antiquity", tags: ['Jabir ibn Hayyan', 'Sepher ha-Razim'] },
  ...
  { number: 212, title: "Esoteric Orthodoxy in East Rome: Jonathan Greig on Maximus the Confessor", url: "https://shwep.net/podcast/esoteric-orthodoxy-in-east-rome-jonathan-greig-on-maximus-the-confessor/", period: "post-antiquity", tags: ['Maximus the Confessor', 'Sepher ha-Razim'] },
  ...
  { number: 215, title: "Gerasimos Merianos on East Roman Alchemy in Late Antiquity and Beyond, Part I", url: "https://shwep.net/podcast/gerasimos-merianos-on-east-roman-alchemy-in-late-antiquity-and-beyond-part-i/", period: "post-antiquity", tags: ['alchemy', 'East Roman', 'Stephanos of Alexandria'] },
  { number: 216, title: "Gerasimos Merianos on East Roman Alchemy in Late Antiquity and Beyond, Part II", url: "https://shwep.net/podcast/gerasimos-merianos-on-east-roman-alchemy-in-late-antiquity-and-beyond-part-ii/", period: "post-antiquity", tags: ['alchemy', 'East Roman', 'Michael Psellos', 'John Malalas', 'Leiden Papyrus', 'Christianos', 'Book of the Eparch', 'Ben Jonson'] },
  { number: 217, title: "Three Ancient Sages: On East Roman Magical Books", url: "https://shwep.net/podcast/three-ancient-sages-on-east-roman-magical-books/", period: "post-antiquity", tags: ['Hermes Trismegistus', 'Apollonios of Tyana', 'Testament of Solomon', 'Hygromanteia', 'Cyranides', 'Kyranides', 'Picatrix', 'Ghāyat al-Ḥakīm', 'Greek Magical Papyri', 'John Malalas', 'Solomon'] },
  // Oddcasts, storytimes, and supplementary episodes
