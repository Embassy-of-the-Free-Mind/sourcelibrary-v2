...
export const LIBRARY_PARTNERS: Record<string, LibraryPartner> = {
  'internet-archive': {
    ...
    // 'ia' is a declared alternate key in image-source.ts (0 visible books
    // today) — folded in so it can never grow into a duplicate tile.
    aliasProviderKeys: ['ia'],
  ...
  // --- Added 2026-09-03 (#4585 follow-up): providers that had visible books
  // but no registry entry, so ~1,050 books were invisible on /libraries. ---
  'goettingen': {
    slug: 'goettingen',
    ...
    description: 'The Göttingen State and University Library (SUB Göttingen) is one of Germany\'s largest research libraries. Its Göttingen Digitization Centre (GDZ) provides access to digitized rare books, scientific journals, and mathematical literature.',
    color: 'sage',
  },
  'etcsl': {
    slug: 'etcsl',
    ...
    description: 'The Electronic Text Corpus of Sumerian Literature at the University of Oxford provides transliterations and translations of nearly 400 Sumerian literary compositions from the late third and early second millennia BCE.',
    color: 'gold',
  },
  'slub-dresden': {
    slug: 'slub-dresden',
    ...
    description: 'The Saxon State and University Library Dresden holds major collections of manuscripts, early prints, maps, and photographs — including the Dresden Codex, one of the four surviving pre-Columbian Maya books.',
    color: 'rust',
  },
  'b-nice': {
    slug: 'b-nice',
    ...
    providerKey: 'b-nice',
    url: 'https://digitalcollections.universiteitleiden.nl',
    description: 'Pustaka Nusantara is a digitization programme for Indonesian and Malay manuscripts, coordinated through Leiden University Libraries and the Koninklijke Bibliotheek with holding institutions across the archipelago.',
    color: 'violet',
  },
  'wikimedia-commons': {
    ...
    description: 'Wikimedia Commons hosts community-digitized manuscripts and rare books, including material from the Wikisource Loves Manuscripts initiative, contributed by volunteers and partner institutions worldwide.',
    color: 'sage',
  },
  'tartu': {
    slug: 'tartu',
    ...
    description: 'The University of Tartu Library is Estonia\'s oldest and largest research library, holding rare books, manuscripts, and the papers of Baltic scholars since 1802.',
    color: 'violet',
  },
  'morgan': {
    slug: 'morgan',
  ...
  'cdli': {
    ...
    description: 'The Cuneiform Digital Library Initiative catalogues and images cuneiform tablets from collections worldwide, in partnership with the Max Planck Institute for the History of Science.',
    color: 'rust',
  },
};
