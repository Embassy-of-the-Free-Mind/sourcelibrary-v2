...
const PREAMBLE_OPENER =
  /^(?:\*\*)?(?:note[:,]|sure[,!:]|certainly|okay|of course|here (?:is|are)\b|here's\b|i(?:'ve| have)\b|i(?:'m| am)\b|i(?:'ll| will)\b|i apologize|i can(?:no|')t\b|the text (?:in|on|of) th(?:e|is) (?:image|page|scan)\b)/i;
