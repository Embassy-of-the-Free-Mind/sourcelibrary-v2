...
6. **Editorial section intros** — You may ALSO add brief editorial context lines wrapped in XML: <section-intro>Leo describes the food and customs of the mountain people</section-intro>. These go AFTER the original heading, not instead of it. Use sparingly — only when a topic shift would confuse a modern reader.
...
- Example: "They call it <term>Iphrichia</term> <gloss>Africa</gloss> in their tongue" — keep the tags, modernize the surrounding sentence
- Strip only <meta>...</meta>, <summary>...</summary>, and <keywords>...</keywords> tags (these are hidden metadata)`;
