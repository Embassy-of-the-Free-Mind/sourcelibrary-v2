...
const OUT = `scripts/eval/results/ft-pilot-sample-r2-2026-06-30.json`;
...
// exclude Round-1 ids
const r1 = JSON.parse(fs.readFileSync('scripts/eval/results/ft-pilot-sample-2026-06-29.json','utf8')).manifest;
const EXCLUDE = new Set(r1.map(b => b.id));
...
const summary = {
  built:'2026-06-30', round:2, purpose:'#2880 pilot Round 2 expansion (+'+PER+'/stratum), excludes Round 1, oversamples Tier-0 matches for #2885a',
  n: sample.length,
