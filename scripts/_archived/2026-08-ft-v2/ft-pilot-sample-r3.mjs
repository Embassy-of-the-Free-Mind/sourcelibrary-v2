...
const OUT = `scripts/eval/results/ft-pilot-sample-r3-2026-06-30.json`;
...
const priorIds = ['ft-pilot-sample-2026-06-29.json','ft-pilot-sample-r2-2026-06-30.json']
...
const summary = {
  built:'2026-06-30', round:3, purpose:'#2880 pilot Round 3 expansion (+'+PER+'/stratum), excludes Round 1, oversamples Tier-0 matches for #2885a',
  n: sample.length,
