// Scripts-side twin of src/lib/field-provenance.ts — keep the two in lockstep.
 ...
 *   });
 */
export function provenanceUpdate(field, input) {
 ...
 */
export function isStampContradicted(entry, value, placeholder) {
