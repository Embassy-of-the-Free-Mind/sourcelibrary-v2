#!/usr/bin/env node
/**
 * PRIOR ART: none — searched scripts/maintenance on 2026-09-22 for cover-
 * related scripts (audit-covers, backfill-bph-cover-thumbs, backfill-cover-
 * cards, backfill-cover-selection, backfill-covers-from-detected-images,
 * backfill-gallery-collection-covers, batch-cover-selection, fix-covers,
 * fix-cross-book-covers-4376, fix-digitizer-covers-4276, generate-missing-
 * page-thumbs, reconcile-cover-fields, repair-cover-thumbs, smart-cover-
 * selection). None targets this specific, narrow case: a live book with a
 * page image that simply never got a `thumbnail` set at all — this backfills
 * exactly the ten books `scripts/audit/record-completeness.mjs` found, not a
 * general cover-repair sweep.
 *
