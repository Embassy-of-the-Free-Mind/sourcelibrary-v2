...
2. SEARCH: query TRADITION-APPROPRIATE sources: ${sourcesFor(b.l)}. Search title/author + "English translation", and the work's common English title. Never answer "no prior" without having actually searched. SOURCE QUALITY: weight library catalogues, scholarly publishers and digital archives heavily (archive.org, HathiTrust, Brill, Cambridge/OUP, university presses, ESTC/VD16/VD17, the tradition catalogues above). DISTRUST aggregator / file-sharing / forum / AI-mirror sites (Scribd, dokumen.pub, pdfcoffee, blogspot, reddit, ebay, goodreads, grokipedia) — do NOT conclude "a prior exists" from those alone, and if your "no prior" rests only on weak sources, set evidence_strength: weak.
