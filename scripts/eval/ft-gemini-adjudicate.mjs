...
RULES:
1. Identify the work precisely; SEPARATE it from related/parent/sibling works and other editions.
2. Search TRADITION-APPROPRIATE sources: ${sourcesFor(b.l)}. Search the title/author + "English translation".
