...
const worklist = JSON.parse(readFileSync('scripts/eval/results/ft-tier2-worklist.json', 'utf8'));
const OUT = 'scripts/eval/ft-tier2-bulk.workflow.js';
...
function buildPrompt(b) {
  return [
    ...
    '3. SOURCE-LANGUAGE RULE: an English translation of the same work from a DIFFERENT source language still counts (verdict not_first or first_from_source); a translation of a DIFFERENT work does NOT count.',
    '4. COMPLETE vs PARTIAL: only partial/excerpt English exists -> first_complete (gate on our item being complete). Only pre-1900 English -> first_modern.',
    '5. If our book is itself an English-language item, or a source-language ORIGINAL, or a non-English translation (e.g. a German/Italian edition), or visual art / scripture manuscript / multi-work container -> not_applicable.',
